...
export default function ServiceCTA({
  ...
  return (
    <section className="grain relative overflow-hidden bg-ink-950 py-16 text-cream-50 lg:py-24">
      <div className="pointer-events-none absolute -right-24 -top-20 h-72 w-72 rounded-full bg-green-500/10 blur-3xl" />
      <div className="container-px relative">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mx-auto mt-6 flex max-w-md items-center justify-center gap-2 text-center text-sm text-ink-400 transition hover:text-green-400"
        >
